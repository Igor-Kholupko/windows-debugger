...
public:
	...
	std::vector<SymHandler*> modulesSymHandlers;
...
protected:
	...
	virtual DWORD CreateProcessDebugEventHandler(CREATE_PROCESS_DEBUG_INFO & stInfo, DWORD dwProcessId, DWORD dwThreadId, BOOL bSymLoaded) = 0;
	...
	virtual DWORD LoadDllDebugEventHandler(LOAD_DLL_DEBUG_INFO & stInfo, DWORD dwProcessId, DWORD dwThreadId, BOOL bSymLoaded) = 0;
